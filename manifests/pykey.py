...
freeze("../python_modules/common", ("rtc.py", "upysh.py", "valuestore.py", "shell.py", "term.py", "virtualtimers.py", "wifi.py", "system.py", "ntp.py", "boot.py", "_boot.py", "ota.py"))
