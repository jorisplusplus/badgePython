...
def loading_text(text):
    ...
    rgb.gif(data, (1, (rgb.screenheight-size[1])//2), size, frames)
...
def _menu_register_callbacks():
    ...
    buttons.register(buttons.BTN_A, _menu_select_callback)
    buttons.register(buttons.BTN_B, _menu_back_callback)
    buttons.register(buttons.BTN_UP, _menu_up_callback)
    buttons.register(buttons.BTN_DOWN, _menu_down_callback)
    buttons.register(buttons.BTN_LEFT, _menu_left_callback)
    buttons.register(buttons.BTN_RIGHT, _menu_right_callback)
...
def _text_input_register_callbacks():
    buttons.init_button_mapping()
    buttons.register(buttons.BTN_A, _text_input_confirm_callback)
    buttons.register(buttons.BTN_B, _text_input_cancel_callback)
    buttons.register(buttons.BTN_UP, _text_input_up_callback)
    buttons.register(buttons.BTN_DOWN, _text_input_down_callback)
    buttons.register(buttons.BTN_LEFT, _text_input_left_callback)
    buttons.register(buttons.BTN_RIGHT, _text_input_right_callback)
...
def _confirmation_dialog_register_callbacks():
    buttons.init_button_mapping()
    buttons.register(buttons.BTN_A, _confirmation_dialog_yes_callback)
    buttons.register(buttons.BTN_B, _confirmation_dialog_no_callback)
...
def skippabletext(text, color=(255, 255, 255), pos=None, width=rgb.screenwidth):
    ...
    buttons.register(buttons.BTN_B, _abort_scroll)
