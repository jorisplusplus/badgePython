import sys, gc, uos as os, uerrno as errno, ujson as json, deflate, urequests, upip_utarfile as tarfile, time, wifi, machine
import consts, rtc
gc.collect()
...
woezel_domain = consts.INFO_WOEZEL_WEB_SERVER
